                        ...
                        <Col key={courseItem._id} className="wd-dashboard-course" style={{ width: "300px" }}>
                            <Card style={{ width: "100%" }} className="h-100">
                                <Link to={`/Kambaz/Courses/${courseItem._id}/Home`}
                                    ...
                                    <Card.Img src={`/images/${courseItem.image}`} variant="top"
                                    ...
                                    <Card.Body className="card-body">
                                        ...
                                        {isFaculty && (
                                            <>
                                                <Button id="wd-delete-course-click" variant="danger"
                                                    className="float-end"
                                                    onClick={(event) => {
                                                        event.preventDefault();
                                                        deleteCourse(courseItem._id);
                                        ...
                                        {isStudent && (
                                            <Button className="float-end me-2 mb-2"
                                                variant={isUserEnrolled(courseItem._id) ? "danger" : "success"}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    toggleEnrollment(courseItem._id);
                                                }}>
                                                {isUserEnrolled(courseItem._id) ? "Unenroll" : "Enroll"}
                                            </Button>
                                        )}
                                    </Card.Body>
                                </Link>
